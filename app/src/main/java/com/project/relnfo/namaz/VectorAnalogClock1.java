...
import com.project.relnfo.namaz.R;
 ...
 *              Enjoy.
 */
public abstract class VectorAnalogClock1 extends RelativeLayout {
    ...
    public VectorAnalogClock1(Context ctx) {
        super(ctx);
        this.ctx = ctx;
    }

    public VectorAnalogClock1(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.ctx = context;
    }

    public VectorAnalogClock1(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.ctx = context;
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public VectorAnalogClock1(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
     ...
     */
    public VectorAnalogClock1 setCalendar(Calendar calendar) {
     ...
     */
    public VectorAnalogClock1 setScale(float scale) {
        this.scale = scale;
     ...
     */
    public VectorAnalogClock1 setDiameterInDp(float diameterInDp){
     ...
     */
    public VectorAnalogClock1 setDiameterInPixels(int diameterInPixels){
     ...
     *               Default: 1.0f
     */
    public VectorAnalogClock1 setOpacity(float opacity) {
     ...
     */
    public VectorAnalogClock1 setColor(int color) {
        this.color = color;
        main(ctx);
     ...
     */
    public VectorAnalogClock1 setShowSeconds(boolean showSeconds) {
    ...
    private void setPositionFor(View v) {
        ...
        Log.e("wahab", "setPositionFor: "+- v.getHeight()/2 + dp);
    }
    ...
    private void tickTick() {
        ...
        Animation positioner = new RotateAnimation(degrees,degrees, Animation.RELATIVE_TO_SELF,0.5f, Animation.RELATIVE_TO_SELF,0.5f);
        positioner.setFillAfter(true);
        positioner.setDuration(0);
        positioner.cancel();

        Animation rotator = new RotateAnimation(360,360, Animation.RELATIVE_TO_SELF,0.5f, Animation.RELATIVE_TO_SELF,0.5f);
